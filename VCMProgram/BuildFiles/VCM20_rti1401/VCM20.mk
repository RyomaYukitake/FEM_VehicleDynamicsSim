...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2021b\bin
RELEASE_VERSION                = R2021b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = VCM20
MODULES                        = VCM20_data.c VCM20_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 4
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\FEM\Documents\MATLAB\VCM_VehicleDynamicSim\VCMProgram\BuildFiles
...
TMP_PATH_CC += "C:\PROGRA~1\DSPACE~1\MATLAB\RTICAN\TLC"
TMP_PATH_CC += "$(MATLAB_ROOT)\rtw\c\src"
